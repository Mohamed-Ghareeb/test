                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-5">
                                    <div class="row mb-2">
                                        <strong class='ml-3'><span>Icon : </span></strong>
                                        @if($company->getFirstMedia('company_icon'))
                                            <img class="" src="{{ $company->getFirstMedia('company_icon')->getUrl() }}" width="100" height="100" alt="...">
                                        @else
                                            N/A
                                        @endif
                                    </div>

        ...
        <div class="container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class=" text-dark font-weight-bold my-1 mr-5"> Edit Employee</h5>
                    <!--end::Page Title-->
                        ...
                        <div class="card-body">
                            <form class="form" action="{{ route('employees.update', $employee->id) }}" method="POST"
                                ...
                                <div class="row container-fluid mb-5">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="submit"
                                                class="btn btn-block btn-sm btn-primary font-weight-bolder text-uppercase py-2">Update Employee
                                            </button>
                                    </div>
                                </div>
                            </form>
